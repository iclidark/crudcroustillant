 ...
 */
final class Version20250929184408 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fromage ADD name VARCHAR(255) DEFAULT NULL, CHANGE name_id burger_id INT DEFAULT NULL');
